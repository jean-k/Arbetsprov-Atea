...
namespace Message_Console_Application
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(" To exit this application please write 'exit' and press enter.");
            Console.WriteLine(" To save all messages to site write 'save' and press enter.");
            Console.WriteLine("\n");
            ...
            while(true)
            {
                ...
                if (message == "save")
                {
                    if (hm.SaveChanges())
                    {
                        Console.WriteLine(" Successfully saved your messages to the site!");
                    }
                    else
                    {
                        Console.WriteLine(" Couldn't not save the messages, please try again later.");
                    }
        }
    }
        }
